...
export const CommandMenu = ({ links }: Props) => {
  ...
  return (
    <>
      <p className="fixed bottom-0 left-0 right-0 hidden border-t border-t-muted bg-white/80 dark:bg-[#0a0a0f]/70 backdrop-blur-xl p-1 text-center text-sm text-muted-foreground print:hidden xl:block">
        Press{" "}
